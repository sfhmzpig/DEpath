...
const int Y = 600; //宽
const int Z = 210; //高
const int L = 1; //每个网格边长
const int Pop = 256; //种群个数
const int NH = 1; //特殊种群个数
const double F = 0.7; //变异力
const double Fmin = 0.4;
const double Fmax = 0.9;
double CRl = 0.1;
double CRu = 0.6;
//double CR = 0.6; //交叉时选择变异体的概率
const int maxIte = 35000; //最大迭代次数
const int reIni = 50001; //判断种群最好个体是否搜寻到更好的结果的迭代次数
const int mut1 = 50000;
const int minNum = 99999; //最小数常数
int w1 = 10;
const double w2 = 0.1;

const std::array<int,3> start_point = {13,502,149}; //起点
const std::array<int,3> end_point = {503,108,200}; //终点
int threat_point[4][3] = {{99,307,47},{246,140,60},{287,246,59},{325,357,67}};
const int D = end_point[0] - start_point[0] + 1; //个体染色体个数
